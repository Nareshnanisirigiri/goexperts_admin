                  ...
                  <div key={item._id}>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button onClick={() => handleEdit(item)} className="p-2 hover:bg-blue-100 dark:hover:bg-blue-900/20 rounded-lg">
                        ...
                        {subItems.sort((a, b) => a.order - b.order).map(sub => (
                          <div key={sub._id} className="flex items-center gap-3 p-3 rounded-lg bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#262626] hover:border-[#F24C20] transition-colors group">
                            ...
                            <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              <button onClick={() => handleEdit(sub)} className="p-1.5 hover:bg-blue-100 dark:hover:bg-blue-900/20 rounded"><Edit className="w-3.5 h-3.5 text-blue-600" /></button>
