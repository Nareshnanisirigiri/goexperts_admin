                                    ...
                                    <motion.tr key={b._id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.04 }}
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center justify-center gap-2">
                                                ...
                                                <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} onClick={() => handleToggle(b)} className={`p-2 rounded-lg transition-colors ${b.is_active ? 'hover:bg-green-100 dark:hover:bg-green-900/20' : 'bg-gray-300 dark:bg-gray-700 hover:bg-gray-400 dark:hover:bg-gray-600'}`} title="Toggle">
                                                    {b.is_active ? <ToggleRight className="w-4 h-4 text-green-600" /> : <ToggleLeft className="w-4 h-4 text-white" />}
                                                </motion.button>
