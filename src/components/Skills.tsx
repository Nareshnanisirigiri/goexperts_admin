                ...
                {loading ? (
                  ...
                  <motion.tr key={skill._id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.03 }}
                    ...
                    <td className="px-6 py-4 text-sm">
                      {skill.category ? (
                        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/20 whitespace-nowrap">
                          {skill.category.name}
                        </span>
                      ) : (
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} onClick={() => handleToggle(skill)} className={`p-2 rounded-lg transition-colors ${skill.is_active ? 'hover:bg-green-100 dark:hover:bg-green-900/20' : 'bg-gray-300 dark:bg-gray-700 hover:bg-gray-400 dark:hover:bg-gray-600'}`} title="Toggle">
                          {skill.is_active ? <ToggleRight className="w-4 h-4 text-green-600" /> : <ToggleLeft className="w-4 h-4 text-white" />}
                        </motion.button>
