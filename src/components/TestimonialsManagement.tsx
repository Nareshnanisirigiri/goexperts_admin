                        ...
                        >
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <div className="flex gap-1">
                                    <button onClick={() => handleEdit(item)} className="p-1.5 hover:bg-blue-100 dark:hover:bg-blue-900/20 rounded-lg transition-colors">
                                        <Edit className="w-4 h-4 text-blue-600" />
                                    </button>
                                    <button onClick={() => handleToggle(item._id)} className={`p-1.5 rounded-lg transition-colors ${item.is_active ? 'hover:bg-gray-100 dark:hover:bg-[#262626]' : 'bg-gray-300 dark:bg-gray-700 hover:bg-gray-400 dark:hover:bg-gray-600'}`}>
                                        {item.is_active ? <ToggleRight className="w-5 h-5 text-green-500" /> : <ToggleLeft className="w-5 h-5 text-white" />}
                                    </button>
